...
<div class="sidebar-wrapper sidebar-theme">
    ...
    <nav id="sidebar">
        ...
        <div class="navbar-nav theme-brand flex-row  text-center">
            <div class="nav-logo">
                ...
                <div class="nav-item theme-text">
                    <a href="{{ route('dashboard') }}" class="nav-link"> Trackmywork </a>
                </div>
            </div>
        ...
        <ul class="list-unstyled menu-categories" id="accordionExample">
            ...
            <li class="menu {{ request()->routeIs('person.*') ? 'active' : '' }}">
                <a href="#users" data-bs-toggle="collapse"
                    aria-expanded="{{ request()->routeIs('person.*') ? 'true' : 'false' }}" class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                ...
                <ul class="collapse submenu list-unstyled {{ request()->routeIs('person.*') ? 'show' : '' }}"
                    id="users" data-bs-parent="#accordionExample">
                    <li>
                        <a href="{{ route('person.list') }}"
                            class="{{ request()->routeIs('person.list') ? 'active' : '' }}"> List </a>
                    </li>
                    <li>
                        <a href="{{ route('person.add') }}"
                            class="{{ request()->routeIs('person.add') ? 'active' : '' }}"> Add New </a>
                    </li>
                </ul>
            </li>
