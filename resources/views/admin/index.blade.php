                            ...
                            <div class="widget widget-card-two">
                                <div class="widget-content">
                                    ...
                                    <div class="card-bottom-section">
                                        ...
                                        <div class="img-group">
                                            <img src="{{asset('src/assets/img/profile-19.jpg')}}" alt="avatar">
                                            <img src="{{asset('src/assets/img/profile-6.jpg')}}" alt="avatar">
                                            <img src="{{asset('src/assets/img/profile-8.jpg')}}" alt="avatar">
                                            <img src="{{asset('src/assets/img/profile-3.jpg')}}" alt="avatar">
                                        </div>
